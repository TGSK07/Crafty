"""
Django settings for crafty_backend project.
...
SECRET_KEY = 'django-insecure-pz)w*x#ws35^6r#ltdy0chs%mai!%-%h8!kd--ej*x!c1hwm%('
...
AUTH_PASSWORD_VALIDATORS = [
    {
        ...
        'OPTIONS': {
            ...
            # increase value (0..1) to allow more similarity — default ~0.7
            'max_similarity': 0.95,
        }
    },
